...
\serge{I would move these research questions into the ``Planning" part of the research design.
In principle, each research question should also come with a 2 sentence motivation which illustrates why it is a relevant question to ask and why a meta-research like a multi-vocal literature survey may provide an answer.
This motivation may come from conflicting opinions, know differences with technical debth in large companies, \ldots.}
...
\serge{I don't see the "planning'' phase anywhere?}
...
\begin{figure}
 ...
 \Description{Types of Primary Sources}  
  ...
  \serge{I would rather see a copy of this picture where you document for each of the arrows how many sources where identified.
...
\serge{I am not a big fan of subsections.
But if you have a subsection on ``Conducting", you should also have one on ``Planning" and on ``Reporting''.
And if you have one on ``Planning'' you should list the research questions there and not in the intro.}
...
\serge{This quality assessment looks interesting.
But then you need to say how this helped.
Did you exclude sources because of this?}
\end{enumerate}


\serge{There is an important section missing here; the ``Data Analysis and Synthesis".
...
\serge{This whole "Findings" section is very unbalanced.
I would move the "Demographics" subsection out of the findings and into the "Research Design".}
...
\serge{Cut this subsection title and move this into the ``Research Design''}
...
\mercy{You will need to document in the analysis part how you arrived at these dimensions}
...
\section{Technical Debt Accumulation Causes}
\label{sec:accumulation}

\serge{This accumulation is interesting. But doesn't appear in the taxonomy?}
...
\serge{This looks \textbf{very} interesting.
...
(c) How this relates to the research questions.
}
