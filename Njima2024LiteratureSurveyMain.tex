...
\mercy{DONE \serge{I would move these research questions into the ``Planning" part of the research design.
...
This motivation may come from conflicting opinions, know differences with technical debt in large companies, \ldots.}}
...
\mercy{Fixed \serge{I am not a big fan of subsections.
...
\mercy{ done\serge{This accumulation is interesting. But doesn't appear in the taxonomy?}}
