...
\begin{tikzpicture}[mindmap, grow cyclic, every node/.style=concept, concept color=grey!40, 
	level 1/.append style={level distance=5cm,sibling angle=90},
	level 2/.append style={level distance=3cm,sibling angle=45},]

\node{Startup Technical Debt Taxonomy}
child [concept color=grey!40] {node {Type}
	child { node {Code}}
...
child [concept color=grey!40] { node {Classification}
...
child [concept color=grey!40] { node {Impact}
...
child [concept color=grey!40] { node {Mitigation}
